...
def main():
    ...
    # Sqlite
    sql_line = q_plot.axhline(131570.63764393827, color='g', linestyle=':',
                              linewidth=2)
    sqli_line = q_plot.axhline(103299.38226969403, color='r', linestyle=':',
                               linewidth=2)
    ...
    # Add a legend
    fig.legend((q_line, sql_line, sqli_line),
               ('query', 'sqlite', 'sqlite with index'),
               loc='lower right')
